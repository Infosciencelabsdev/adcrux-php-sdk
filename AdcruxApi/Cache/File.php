<?php
/**
 * This file contains the File cache class used in the AdcruxApi PHP-SDK.
 *
...
/**
 * AdcruxApi_Cache_File makes use of the file system in order to cache data.
 *
 * @package AdcruxApi
 * @subpackage Cache
 * @since 1.0
 */
class AdcruxApi_Cache_File extends AdcruxApi_Cache_Abstract
{
    /**
