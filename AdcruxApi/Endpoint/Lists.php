<?php
/**
 * This file contains the lists endpoint for AdcruxApi PHP-SDK.
 *
...
/**
 * AdcruxApi_Endpoint_Lists handles all the API calls for lists.
 *
 * @package AdcruxApi
 * @subpackage Endpoint
 * @since 1.0
 */
class AdcruxApi_Endpoint_Lists extends AdcruxApi_Base
{
    /**
