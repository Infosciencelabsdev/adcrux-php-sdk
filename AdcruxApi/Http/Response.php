<?php
/**
 * This file contains the AdcruxApi_Http_Response class used in the AdcruxApi PHP-SDK.
 *
...
/**
 * AdcruxApi_Http_Response is the class used to get the responses back from the API endpoints.
 *
 * @package AdcruxApi
 * @subpackage Http
 * @since 1.0
 */
class AdcruxApi_Http_Response extends AdcruxApi_Base
{
    /**
    ...
    /**
     * @var AdcruxApi_Params $headers the headers that came back in the response.
     */
    public $headers;
    ...
    /**
     * @var AdcruxApi_Params $curlInfo the curl info returned in the response.
     */
    public $curlInfo;
    
    /**
     * @var AdcruxApi_Params $body the body of the response.
     */
    public $body;
     ...
     * Contructor.
     *
     * @param AdcruxApi_Http_Request $request
     *
     * @throws ReflectionException
     */
    public function __construct(AdcruxApi_Http_Request $request)
    {
    ...
    public function populate(array $params = array())
    {
        if ($this->storeCurlInfo) {
            $this->curlInfo = new AdcruxApi_Params($params);
        }
