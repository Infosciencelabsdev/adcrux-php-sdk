<?php
/**
 * This file contains the base class for the AdcruxApi PHP-SDK.
 *
...
/**
 * AdcruxApi_Base is the base class for all the other classes used in the sdk.
 *
 * @package AdcruxApi
 * @since 1.0
 */
class AdcruxApi_Base
{
    /**
    ...
    /**
     * @var AdcruxApi_Config the configuration object injected into the application at runtime
     */
    private static $_config;
    
    /**
     * @var AdcruxApi_Params the package registry that will hold various components
     */
    private static $_registry;
    
    /**
     * @var AdcruxApi_Params the registered event handlers
     */
     ...
     *
     * @param AdcruxApi_Config $config
     * @return void
     */
    public static function setConfig(AdcruxApi_Config $config)
    {
        self::$_config = $config;
    }
     ...
     *
     * @return AdcruxApi_Params
     * @throws Exception
     */
    public function getRegistry()
    {
        if (!(self::$_registry instanceof AdcruxApi_Params)) {
            self::$_registry = new AdcruxApi_Params(is_array(self::$_registry) ? self::$_registry : array());
        }
    ...
    public function setComponent($componentName, array $config)
    {
        ...
        if ($component instanceof AdcruxApi_Base) {
    ...
    {
        if (!(self::$_eventHandlers instanceof AdcruxApi_Params)) {
            self::$_eventHandlers = new AdcruxApi_Params(self::$_eventHandlers);
        }
        
        if (!self::$_eventHandlers->contains($eventName) || !(self::$_eventHandlers->itemAt($eventName) instanceof AdcruxApi_Params)) {
            self::$_eventHandlers->add($eventName, new AdcruxApi_Params());
        }
